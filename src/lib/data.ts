...
export const ACTIVITIES: Activity[] = [
  {
    ...
    prior: {
      ...
      desc: "Newborns naturally love bold patterns. Until now, dim lighting and your face were the main thing they had to look at.",
    },
  ...
  },
  {
    ...
    prior: {
      stage: "Newborn (0–3 months)",
      desc: "Until now, most of baby's sensory input came from being held and cuddled. The basket lets them go and find textures for themselves.",
    },
  ...
  },
  {
    ...
    prior: {
      ...
      desc: "They used to just listen while you sang. Now they get to be the music maker, which is a huge step in feeling like they can cause things to happen.",
    },
  ...
  },
  {
    ...
    steps: [
      ...
      "Refill and repeat. They'll want to do it again and again.",
    ],
    prior: {
      stage: "Baby (6–12 months)",
      desc: "This builds on peek-a-boo. Now they get to be the one making things disappear and come back.",
    },
  ...
  },
  {
    ...
    prior: {
      ...
      desc: "At one, water play meant splashing in the bath and feeling wet or dry. Now they're ready to use containers and pour with purpose, which builds wrist control and an early sense of volume.",
    },
  ...
  },
  {
    ...
    prior: {
      stage: "1 year, Wobbler",
      desc: "They used to love pointing at the parts of your face. Now they can put together a face of their own, which is early symbolic thinking.",
    },
  ...
  },
  {
    ...
    prior: {
      stage: "1 year, Wobbler",
      desc: "Their hand strength has come from squishing food at mealtimes. Dough turns that into longer, more focused sensory play.",
    },
  ...
  },
  {
    ...
    prior: {
      ...
      desc: "At two, water play introduced pouring. Rice is the next step. It's solid but flowy, so it builds the same skills with a totally different feel (and a bit less mess).",
    },
  ...
  },
  {
    ...
    prior: {
      stage: "2 years, Tiny explorer",
      desc: "Two-year-olds loved naming the things they spotted outside. The hunt adds a goal and a sequence, which stretches memory and category words.",
    },
  ...
  },
  {
    ...
    steps: [
      ...
      "Call out a sound. The child hops to that letter.",
      "Switch roles: child calls the sound for you.",
      "Use only sounds they recognise to keep it fun.",
    ],
    prior: {
      stage: "3 years, Curious kid",
      desc: "At three, it was all about rhymes and singing the alphabet. Now they can connect sounds to written letters, which is the first real phonics step.",
    },
  ...
  },
  {
    ...
    prior: {
      stage: "3 years, Curious kid",
      desc: "Three-year-olds loved mark-making just for fun. Now writing has a purpose: getting a message across. That's the seed of literacy.",
    },
  ...
  },
  {
    ...
    prior: {
      ...
      desc: "At four, building was about stacking and balancing. Now they can hold a plan in their head across several attempts. That's early engineering thinking.",
    },
  ...
  },
  {
    ...
    prior: {
      stage: "4 years, Pre-schooler",
      desc: "Four-year-olds loved being told stories. At five, they can build one themselves with a beginning, middle and end. That's a huge leap in storytelling.",
    },
...
const KEYWORDS: Record<string, KeywordTemplate> = {
  ...
  build:    { emoji: "🧱", area: "STEM · Problem solving", color: "#a37cf0",
              ...
              steps: ["Set a challenge, like 'a tower taller than teddy'.", "Let the child plan and build.", "Test it. If it falls, talk about why.", "Try a new design together."],
...
const PRIOR_STAGE: Record<AgeKey, PriorStage> = {
  ...
  5: { stage: "4 years, Pre-schooler", desc: "Pre-schoolers loved imaginative play. By five they can layer in rules, sequences and longer storylines. Those are early formal learning skills." },
};
  ...
  if (!match) {
    match = {
      ...
      steps: [
        ...
        "Follow your child's lead. Try not to direct.",
